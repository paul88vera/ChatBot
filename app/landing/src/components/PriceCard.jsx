...
const PriceCard = ({
  ...
  return (
    <div key={id} style={{display: "flex", flexDirection: "column", gap: "1rem", justifyContent: "start", alignContent: "center", textAlign: "center", padding: "2rem", width: "100%", maxWidth: "350px", border: `2px solid #3b3b3bff`, borderRadius: "10px", backgroundFilter: "blur(20px)", backgroundColor: "#000000"}}>
